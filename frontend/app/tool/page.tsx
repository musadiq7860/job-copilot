...
export default function ToolPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Your tailored application has been downloaded successfully.");
    } catch (err: unknown) {
      const message =
  ...
  return (
    <main style={{ background: "#06060f", minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        <Link href="/dashboard" style={{ fontWeight: 800, fontSize: 22, letterSpacing: -0.5 }}>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "60px 40px" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 15 }}>
            Upload your resume and paste the job description. We will do the rest.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div
              ...
              style={{
                border: `2px dashed ${dragOver ? "#4ade80" : resumeFile ? "rgba(74,222,128,0.3)" : "rgba(255,255,255,0.1)"}`,
                borderRadius: 16, padding: "40px 24px", textAlign: "center",
                cursor: "pointer", transition: "all 0.2s ease",
                background: dragOver ? "rgba(74,222,128,0.04)" : resumeFile ? "rgba(74,222,128,0.02)" : "transparent"
              }}
            >
              {resumeFile ? (
                <div>
                ...
                <div>
                  <div style={{ fontSize: 15, fontWeight: 600, color: "rgba(255,255,255,0.5)", marginBottom: 4 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {toneOptions.map((t) => (
                <button key={t} type="button" onClick={() => setTone(t)} style={{
                  ...
                  borderRadius: 10,
                  border: tone === t ? "1px solid rgba(74,222,128,0.3)" : "1px solid rgba(255,255,255,0.08)",
                  background: tone === t ? "rgba(74,222,128,0.1)" : "rgba(255,255,255,0.03)",
          ...
          <button type="submit" disabled={submitting} style={{
            width: "100%", padding: "18px 0", fontSize: 15,
            ...
            {submitting ? "Tailoring your application..." : "Tailor My Application →"}
          </button>
        ...
        <div style={{ textAlign: "center", marginTop: 28 }}>
          <Link href="/dashboard" style={{ color: "rgba(255,255,255,0.3)", fontSize: 13 }}>
            ← Back to dashboard
          </Link>
        </div>
